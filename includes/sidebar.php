<div class="col-md-2 sidebar d-none d-md-block">
    ...
    <nav class="mt-3">
        ...
        <?php if($_SESSION['nombre_rol'] == 'Administrador' || $_SESSION['nombre_rol'] == 'Administrativo'): ?>
        ...
        <div class="border-top border-secondary mt-2 pt-2">
            ...
            <a href="/casahogar/modulos/configuracion/index.php"><i class="fas fa-cog me-2"></i> Configuración</a>
            <a href="/casahogar/modulos/servicios/index.php"><i class="fas fa-concierge-bell me-2"></i> Servicios</a>
        </div>
        <?php endif; ?>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom px-4 py-3">
        <div class="container-fluid">
            ...
            <div class="d-flex align-items-center">
                <span class="me-3"><i class="fas fa-user-circle me-1"></i> <?php echo htmlspecialchars($_SESSION['nombre_usuario']); ?></span>
